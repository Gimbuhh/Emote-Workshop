...
4. Add `release-notes/<version>.md` and a matching dated `CHANGELOG.md` entry. Both describe published-version-to-published-version user outcomes; omit test-only and repository-maintenance work.
